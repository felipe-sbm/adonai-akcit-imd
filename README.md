...
# Adonai- Agente de Revisão de Código com IA

Sistema de revisão de código com inteligência artificial, desenvolvido como projeto do curso de parceria do **IMD/UFRN** e do **Akcit**. Todo o projeto foi reconstruído do zero sem utilizar LLMS, somente trabalho humano.
...
![Logo do NotByAI, representando que não foi produzido por IA.](not-by-ai.webp)
